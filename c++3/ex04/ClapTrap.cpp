...
void ClapTrap::show()
{
	...
	std::cout << "_hit_point " << _hit_point << std::endl;
	std::cout << "_max_hit_point " << _max_hit_point << std::endl;
	std::cout << "_energ_point " << _energ_point << std::endl;
	std::cout << "_max_hit_point " << _max_energ_point << std::endl;
	std::cout << "_level " << _level << std::endl;
	std::cout << "_amor " << _amor << std::endl;
	std::cout << "_range_at " << _range_at << std::endl;
	std::cout << "_mel_at " << _mel_at << std::endl;
}
